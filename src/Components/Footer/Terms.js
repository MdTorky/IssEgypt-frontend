const Terms = () => {
    return (
        <div className="TermsCondition">
            ...
            <p>Welcome to ISS Egypt Gateway!</p>

            <p>These terms and conditions outline the rules and regulations for the use of ISS Egypt's Website, located at
                <a href="https://issegypt.vercel.app/"> https://issegypt.vercel.app/.</a></p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use ISS Egypt Gateway
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and all
                ...
                accordance with and subject to, prevailing law of my. Any use of the above terminology or other words in the
                singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to
                same.</p>

            <h3><strong>Cookies</strong></h3>

            <p>We employ the use of cookies. By accessing ISS Egypt Gateway, you agreed to use cookies in agreement with the ISS
                Egypt's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, ISS Egypt and/or its licensors own the intellectual property rights for all material on ISS
                Egypt Gateway. All intellectual property rights are reserved. You may access this from ISS Egypt Gateway for your
                own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from ISS Egypt Gateway</li>
                <li>Sell, rent or sub-license material from ISS Egypt Gateway</li>
                <li>Reproduce, duplicate or copy material from ISS Egypt Gateway</li>
                <li>Redistribute content from ISS Egypt Gateway</li>
            </ul>

            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas
                of the website. ISS Egypt does not filter, edit, publish or review Comments prior to their presence on the website.
                Comments do not reflect the views and opinions of ISS Egypt,its agents and/or affiliates. Comments reflect the views
                and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, ISS Egypt
            ...
            <p>ISS Egypt reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant ISS Egypt a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
                ...
                with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of ISS Egypt; and (d)
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
                must inform us by sending an e-mail to ISS Egypt. Please include your name, your organization name, contact
            ...
            <p>No use of ISS Egypt's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
